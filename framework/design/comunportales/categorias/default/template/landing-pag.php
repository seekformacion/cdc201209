...
$d_layout[urlLogo]=GetSKINPath('logo.png',$design);
...
include GetPath('template/listadoCursosLanding-pag.php',$design);
...
echo splitsheet(read_layout(GetPath('layout/landing-pag.html',$design)),"layout",$d_layout,"");
